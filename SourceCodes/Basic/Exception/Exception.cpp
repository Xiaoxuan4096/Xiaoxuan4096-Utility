...
#include "../../../Headers/Basic/Exception/Exception.h"

#include "../../../Headers/Basic/StringUtilities/StringUtilities.h"

Xiaoxuan4096::Exception::Exception::Exception(std::wstring exceptionDetail) {
	detail = exceptionDetail;
	GetLocalTime(&time);
	return;
}

std::wstring Xiaoxuan4096::Exception::Exception::getExceptionDetail() {
	return detail;
}
SYSTEMTIME Xiaoxuan4096::Exception::Exception::getExceptionTime() {
	return time;
}

std::wstring Xiaoxuan4096::Exception::what(Exception exception) {
